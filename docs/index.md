...
Welcome to the Bunlet documentation! Bunlet is a desktop application framework that combines Bun's speed with native WebView rendering.
...
### Guides
- [Window Management](guides/window-management.md)
- [IPC Communication](guides/ipc-communication.md)
- [Native APIs](guides/native-apis.md)
- [Preload Scripts](guides/preload-scripts.md)
- [Hot Reload](guides/hot-reload.md)
- [Debugging](guides/debugging.md)

### CLI Reference
- [Overview](cli/overview.md)
- [bunlet create](cli/create.md)
- [bunlet dev](cli/dev.md)
...
- [Platform Guides](packaging/platforms.md)
...
### WebView Engines
- [System WebView](webview/system-webview.md)
- [CEF Mode](webview/cef-mode.md)
- [Comparison](webview/comparison.md)
...
### Migration
- [From Electron](migration/from-electron.md)
- [From Tauri](migration/from-tauri.md)
...
See the [Contributing Guide](../CONTRIBUTING.md) to get started with development.
